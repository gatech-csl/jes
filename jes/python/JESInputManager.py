...
class JESInputManager(Borg):
    ...
    def readInput(self, message):
        # to be threadsafe on this call we need this to update the command
        # window
        class outputPromptRunner(Runnable):
            ...
            def run(self):
                ...
                self.commandWindow.setCaretPosition(
                    self.commandWindow.document.getLength())
        ...
        SwingUtilities.invokeAndWait(
            outputPromptRunner(self.commandWindow, message))
