...
//    }
    ...
    private void setUpIndexPanel(JPanel indexPanel) {
        ...
        Icon prevIcon = JESResources.makeIcon("images/leftArrow.gif", "previous index");
        Icon nextIcon = JESResources.makeIcon("images/rightArrow.gif", "next index");
        Icon firstIcon = JESResources.makeIcon("images/endLeft.gif", "first index");
        Icon lastIcon = JESResources.makeIcon("images/endRight.gif", "last index");
