...
Requirements
------------
This is a Windows package of JES, including a Java Runtime Environment.
Since all the requirements are included in the package, this should run on
Windows Vista, 7, or any newer version.
