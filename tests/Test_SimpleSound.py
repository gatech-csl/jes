...
class Test_SimpleSound_AIFC(unittest.TestCase):
    ...
    def setUp(self):
        self.original = SimpleSound()
        audioFormat = AudioFormat(
            AudioFormat.Encoding.ALAW, 22050, 16, 1, 16, 22050, 0)
        AFF = AudioFileFormat(AudioFileFormat.Type.WAVE, audioFormat, 6615)
...
class Test_SimpleSound_PCMSIGNED(unittest.TestCase):
    ...
    def setUp(self):
        self.original = SimpleSound()
        audioFormat = AudioFormat(
            AudioFormat.Encoding.PCM_SIGNED, 22050, 16, 1, 16, 22050, 0)
        AFF = AudioFileFormat(AudioFileFormat.Type.WAVE, audioFormat, 6615)
        self.original.setAudioFileFormat(AFF)
        self.simple = SimpleSound(self.original)
...
class Test_SimpleSound_PCMUNSIGNED(unittest.TestCase):
    ...
    def setUp(self):
        self.original = SimpleSound()
        audioFormat = AudioFormat(
            AudioFormat.Encoding.PCM_UNSIGNED, 22050, 16, 1, 16, 22050, 0)
        AFF = AudioFileFormat(AudioFileFormat.Type.WAVE, audioFormat, 6615)
        self.original.setAudioFileFormat(AFF)
        self.simple = SimpleSound(self.original)
...
class Test_SimpleSound_ULAW(unittest.TestCase):
    ...
    def setUp(self):
        self.original = SimpleSound()
        audioFormat = AudioFormat(
            AudioFormat.Encoding.ULAW, 22050, 16, 1, 16, 22050, 0)
        AFF = AudioFileFormat(AudioFileFormat.Type.WAVE, audioFormat, 6615)
        self.original.setAudioFileFormat(AFF)
        self.simple = SimpleSound(self.original)
...
class Test_SimpleSound_22KSR(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.original = SimpleSound()
        audioFormat = AudioFormat(
            AudioFormat.Encoding.PCM_SIGNED, self.samplingRate, 16, 1, 16, 22050, 0)
        AFF = AudioFileFormat(AudioFileFormat.Type.WAVE, audioFormat, 6615)
        self.original.setAudioFileFormat(AFF)
        self.simple = SimpleSound(self.original)
...
class Test_SimpleSound_16sample(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.original = SimpleSound()
        audioFormat = AudioFormat(
            AudioFormat.Encoding.PCM_SIGNED, 22050, self.sampleSizeBits, 1, 16, 22050, 0)
        AFF = AudioFileFormat(AudioFileFormat.Type.WAVE, audioFormat, 6615)
        self.original.setAudioFileFormat(AFF)
        self.simple = SimpleSound(self.original)
...
class Test_SimpleSound_1c(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.original = SimpleSound()
        audioFormat = AudioFormat(
            AudioFormat.Encoding.PCM_SIGNED, 22050, 16, self.channels, 16, 22050, 0)
        AFF = AudioFileFormat(AudioFileFormat.Type.WAVE, audioFormat, 6615)
        self.original.setAudioFileFormat(AFF)
        self.simple = SimpleSound(self.original)
...
class Test_SimpleSound_2frame(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.original = SimpleSound()
        audioFormat = AudioFormat(
            AudioFormat.Encoding.PCM_SIGNED, 22050, 16, 1, self.frameSizeBytes, 22050, 0)
        AFF = AudioFileFormat(AudioFileFormat.Type.WAVE, audioFormat, 6615)
        self.original.setAudioFileFormat(AFF)
        self.simple = SimpleSound(self.original)
...
class Test_SimpleSound_22KFR(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.original = SimpleSound()
        audioFormat = AudioFormat(
            AudioFormat.Encoding.PCM_SIGNED, 22050, 16, 1, 2, self.frameRate, 0)
        AFF = AudioFileFormat(AudioFileFormat.Type.WAVE, audioFormat, 6615)
        self.original.setAudioFileFormat(AFF)
        self.simple = SimpleSound(self.original)
...
class Test_SimpleSound_se(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.original = SimpleSound()
        audioFormat = AudioFormat(
            AudioFormat.Encoding.PCM_SIGNED, 22050, 16, 1, 2, 22050, self.isBigEndian)
        AFF = AudioFileFormat(AudioFileFormat.Type.WAVE, audioFormat, 6615)
        self.original.setAudioFileFormat(AFF)
        self.simple = SimpleSound(self.original)
...
class Test_SimpleSound_fl(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.original = SimpleSound()
        audioFormat = AudioFormat(
            AudioFormat.Encoding.PCM_SIGNED, 22050, 16, 1, 2, 22050, 0)
        AFF = AudioFileFormat(
            AudioFileFormat.Type.WAVE, audioFormat, self.frameLength)
        self.original.setAudioFileFormat(AFF)
        self.simple = SimpleSound(self.original)
    ...
    def testByteOrder(self):
        ...
        if(len(simpleBuffer) == len(originalBuffer)):
            for byte in simpleBuffer:
                self.assertEquals(simpleBuffer[byte], originalBuffer[
                                  byte], 'ByteBuffer is different at byte %s' % byte)
        else:
