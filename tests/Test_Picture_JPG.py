...
class Test_Picture_JPG(unittest.TestCase):
    ...
    def testPictureStrB1(self):
        ...
        self.pict = Picture()
        # NOTE: USING 1 == true
        self.assertEqual(self.pict.load(WHITE_JPG), 1, 'white.jpg could not be loaded')

    def testPictureStrB2(self):
        '''Test Picture(String) constructor (jpg) [2] - filename'''
        self.pict = Picture(WHITE_JPG)
        self.assertEqual(self.pict.getFileName(), WHITE_JPG, 'Filename %s != %s' % (self.pict.getFileName(), WHITE_JPG))
    ...
    def testPictureStrB4(self):
        ...
        self.pict = Picture(WHITE_JPG)
        self.assertEqual(self.pict.getTitle(), WHITE_JPG_TITLE, 'Title %s != %s' % (self.pict.getTitle(), WHITE_JPG_TITLE))
    ...
    def testPictureCopyB1(self):
        ...
        self.assertEqual(self.pict2.getFileName(), WHITE_JPG, 'Filename %s != %s' % (self.pict2.getFileName(), WHITE_JPG))
    ...
    def testPictureCopyB3(self):
        ...
        self.pict = Picture(WHITE_JPG)
        self.pict2 = Picture(self.pict)
        self.assertEqual(self.pict2.getTitle(), WHITE_JPG_TITLE, 'Title %s != %s' % (self.pict2.getTitle(), WHITE_JPG_TITLE))
    ...
    def testTitlePsB(self):
        ...
        self.assertNotEqual(self.pict.getTitle(), WHITE_JPG_TITLE, 'Title is still white.jpg')
    ...
    def testWriteB(self):
        ...
        self.pict1 = Picture()
        # NOTE: USING 1 == true
        self.assertEqual(self.pict1.load(WHITE_JPG), 1, 'white.jpg could not be loaded, so write will not be tested')
