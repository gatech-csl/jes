...
WHITE_JPG = PICTURES + "white.jpg"
WHITE_JPG_TITLE = WHITE_JPG
...
class Test_Picture_JPG(unittest.TestCase):
    ...
    def testPictureStrB1(self):
        ...
        # NOTE: USING 1 == true
        self.assertEqual(
            self.pict.load(WHITE_JPG), 1, 'white.jpg could not be loaded')

    def testPictureStrB2(self):
        '''Test Picture(String) constructor (jpg) [2] - filename'''
        self.pict = Picture(WHITE_JPG)
        self.assertEqual(self.pict.getFileName(), WHITE_JPG, 'Filename %s != %s' % (
            self.pict.getFileName(), WHITE_JPG))

    def testPictureStrB3(self):
        '''Test Picture(String) constructor (jpg) [3] - extension'''
        self.pict = Picture(WHITE_JPG)
        self.assertEqual(self.pict.getExtension(), 'jpg',
                         'File extension %s != jpg' % self.pict.getExtension())

    def testPictureStrB4(self):
        '''Test Picture(String) constructor (jpg) [4] - title'''
        self.pict = Picture(WHITE_JPG)
        self.assertEqual(self.pict.getTitle(), WHITE_JPG_TITLE, 'Title %s != %s' % (
            self.pict.getTitle(), WHITE_JPG_TITLE))
    ...
    def testPictureStrB7(self):
        ...
        self.pict = Picture(WHITE_JPG)
        self.assertEqual(self.pict.toString(), 'Picture, filename %s height 50 width 50' % WHITE_JPG,
                         'toString %s != Picture, filename %s height 50 width 50' % (self.pict.toString(), WHITE_JPG))
    ...
    def testPictureCopyB1(self):
        ...
        self.assertEqual(self.pict2.getFileName(), WHITE_JPG, 'Filename %s != %s' % (
    ...
    def testPictureCopyB2(self):
        ...
        self.pict = Picture(WHITE_JPG)
        self.pict2 = Picture(self.pict)
        self.assertEqual(self.pict2.getExtension(), 'jpg',
    ...
    def testPictureCopyB3(self):
        ...
        self.pict = Picture(WHITE_JPG)
        self.pict2 = Picture(self.pict)
        self.assertEqual(self.pict2.getTitle(), WHITE_JPG_TITLE, 'Title %s != %s' % (
    ...
    def testPictureCopyB4(self):
        ...
        self.pict2 = Picture(self.pict)
        self.assertEqual(
            self.pict2.getWidth(), 50, 'Width %s != 50' % self.pict2.getWidth())
    ...
    def testPictureCopyB5(self):
        ...
        self.pict2 = Picture(self.pict)
        self.assertEqual(
            self.pict2.getHeight(), 50, 'Height %s != 50' % self.pict2.getHeight())
    ...
    def testTitlePsB(self):
        ...
        self.assertNotEqual(
            self.pict.getTitle(), WHITE_JPG_TITLE, 'Title is still white.jpg')
        self.assertEqual(self.pict.getTitle(), 'Not white.jpg',
                         'Title %s != Not white.jpg' % self.pict.getTitle())

    def testGetPictureWithHeightB1(self):
        '''Test Picture.getPictureWithHeight(int) (jpg) [1] - smaller'''
        self.pict = Picture()
        self.loaded = self.pict.load(PICTURES + "addMsg.jpg")
        ...
        self.pictSm1.write(OUTPUT + "addMsgSmOut.jpg")
        self.pictSm2 = Picture()
        self.loaded = self.pictSm2.load(OUTPUT + "addMsgSmOut.jpg")
        self.assertEqual(self.loaded, 1, "Write seems to be broken")
        self.pictSm3 = Picture(PICTURES + "addMsgSm.jpg")
    ...
    def testGetPictureWithHeightB2(self):
        ...
        self.pictLg1.write(OUTPUT + "addMsgLgOut.jpg")
        self.pictLg2 = Picture()
        self.loaded = self.pictLg2.load(OUTPUT + "addMsgLgOut.jpg")
        self.assertEqual(self.loaded, 1, "Write seems to be broken")
        self.pictLg3 = Picture(PICTURES + "addMsgLg.jpg")
    ...
    def testWriteB(self):
        ...
        self.pict1 = Picture()
        # NOTE: USING 1 == true
        self.assertEqual(self.pict1.load(
            WHITE_JPG), 1, 'white.jpg could not be loaded, so write will not be tested')
        self.pict2 = Picture(WHITE_JPG)
        self.pict2.write(OUTPUT + "writeTest.jpg")
        self.pict3 = Picture(OUTPUT + "writeTest.jpg")
