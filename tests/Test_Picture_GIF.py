...
WHITE_GIF = PICTURES + "white.gif"
WHITE_GIF_TITLE = WHITE_GIF
...
class Test_Picture_GIF(unittest.TestCase):
    ...
    def testPictureStrB1(self):
        ...
        self.pict = Picture()
        # NOTE: USING 1 == true
        self.assertEqual(self.pict.load(WHITE_GIF), 1, 'white.gif could not be loaded')

    def testPictureStrB2(self):
        '''Test Picture(String) constructor (gif) [2] - filename'''
        self.pict = Picture(WHITE_GIF)
        self.assertEqual(self.pict.getFileName(), WHITE_GIF, 'Filename %s != %s' % (self.pict.getFileName(), WHITE_GIF))
    ...
    def testPictureStrB4(self):
        ...
        self.pict = Picture(WHITE_GIF)
        self.assertEqual(self.pict.getTitle(), WHITE_GIF_TITLE, 'Title %s != %s' % (self.pict.getTitle(), WHITE_GIF_TITLE))
    ...
    def testPictureCopyB1(self):
        ...
        self.assertEqual(self.pict2.getFileName(), WHITE_GIF, 'Filename %s != %s' % (self.pict2.getFileName(), WHITE_GIF))
    ...
    def testPictureCopyB3(self):
        ...
        self.pict = Picture(WHITE_GIF)
        self.pict2 = Picture(self.pict)
        self.assertEqual(self.pict2.getTitle(), WHITE_GIF_TITLE, 'Title %s != %s' % (self.pict2.getTitle(), WHITE_GIF_TITLE))
    ...
    def testTitlePsB(self):
        ...
        self.assertNotEqual(self.pict.getTitle(), WHITE_GIF_TITLE, 'Title is still %s' % WHITE_GIF)
