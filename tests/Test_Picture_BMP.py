...
class Test_Picture_BMP(unittest.TestCase):
    ...
    def testPictureStrB1(self):
        ...
        # NOTE: USING 1 == true
        self.assertEqual(
            self.pict.load(WHITE_BMP), 1, 'white.bmp could not be loaded')

    def testPictureStrB2(self):
        '''Test Picture(String) constructor (bmp) [2] - filename'''
        self.pict = Picture(WHITE_BMP)
        self.assertEqual(self.pict.getFileName(), WHITE_BMP, 'Filename %s != %s' % (
            self.pict.getFileName(), WHITE_BMP))

    def testPictureStrB3(self):
        '''Test Picture(String) constructor (bmp) [3] - extension'''
        self.pict = Picture(WHITE_BMP)
        self.assertEqual(self.pict.getExtension(), 'bmp',
                         'File extension %s != bmp' % self.pict.getExtension())

    def testPictureStrB4(self):
        '''Test Picture(String) constructor (bmp) [4] - title'''
        self.pict = Picture(WHITE_BMP)
        self.assertEqual(self.pict.getTitle(), WHITE_BMP_TITLE, 'Title %s != %s' % (
    ...
    def testPictureStrB7(self):
        ...
        self.pict = Picture(WHITE_BMP)
        self.assertEqual(self.pict.toString(), 'Picture, filename %s height 50 width 50' % WHITE_BMP,
                         'toString %s != Picture, filename %s height 50 width 50' % (self.pict.toString(), WHITE_BMP))
    ...
    def testPictureCopyB1(self):
        ...
        self.assertEqual(self.pict2.getFileName(), WHITE_BMP, 'Filename %s != %s' % (
            self.pict2.getFileName(), WHITE_BMP))

    def testPictureCopyB2(self):
        '''Test Picture(copyPicture) constructor (bmp) [2] - extension'''
        self.pict = Picture(WHITE_BMP)
        self.pict2 = Picture(self.pict)
        self.assertEqual(self.pict2.getExtension(), 'bmp',
    ...
    def testPictureCopyB3(self):
        ...
        self.pict = Picture(WHITE_BMP)
        self.pict2 = Picture(self.pict)
        self.assertEqual(self.pict2.getTitle(), WHITE_BMP_TITLE, 'Title %s != %s' % (
            self.pict2.getTitle(), WHITE_BMP_TITLE))
    ...
    def testTitlePsB(self):
        ...
        self.assertNotEqual(
            self.pict.getTitle(), WHITE_BMP_TITLE, 'Title is still white.bmp')
    ...
    def testWriteB(self):
        ...
        self.pict1 = Picture()
        # NOTE: USING 1 == true
        self.assertEqual(self.pict1.load(WHITE_BMP), 1,
                         'white.bmp could not be loaded, so write will not be tested')
